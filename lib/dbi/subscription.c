...
/*int ogs_dbi_subscription_session_data(char *supi,
    ...
    while (bson_iter_next(&iter)) {
        ...
        if (!strcmp(key, "msisdn") &&
                    ...
                    if (!strcmp(child2_key, "sst") &&
                        ...
                        while (bson_iter_next(&child3_iter)) {
                            ...
                            while (bson_iter_next(&child4_iter)) {
                                ...
                                } else if (!strcmp(child4_key, "pcc_rule") && BSON_ITER_HOLDS_ARRAY(&child4_iter)) {
            ...
            while (bson_iter_next(&child5_iter)) {
                ...
                pcc_rule->name = ogs_msprintf("%s-g%d", "pollon", pcc_rule_index+1);
                ...
                pcc_rule->id = ogs_msprintf("%s-n%d", "pollon", pcc_rule_index+1);
